export type DesignLanguage = 'neo-brutalism' | 'glassmorphism' | 'minimalism' | 'cyberpunk' | 'dashboard' | 'space-mission' | 'modern' | 'editorial' | 'warm-organic' | 'handrawn-sketch' | 'retro-pixel' | 'risograph' | 'doodle-sketch';
