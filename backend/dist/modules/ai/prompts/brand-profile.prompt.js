...
exports.BRAND_PROFILE_LIMITS = void 0;
exports.buildBrandProfilePrompt = buildBrandProfilePrompt;
exports.BRAND_PROFILE_LIMITS = {
    shortBio: 90,
    longBio: 180,
    brandStyle: 80,
    galleryTitle: 50,
...
function buildBrandProfilePrompt(input) {
...
- short_bio: tối đa ${exports.BRAND_PROFILE_LIMITS.shortBio} ký tự, 1-2 câu
- long_bio: tối đa ${exports.BRAND_PROFILE_LIMITS.longBio} ký tự, 2-3 câu ngắn
- brand_style: tối đa ${exports.BRAND_PROFILE_LIMITS.brandStyle} ký tự
- gallery.title: tối đa ${exports.BRAND_PROFILE_LIMITS.galleryTitle} ký tự
- gallery.description: tối đa ${exports.BRAND_PROFILE_LIMITS.galleryDescription} ký tự
...
Mỗi ảnh cần:
- title tối đa ${exports.BRAND_PROFILE_LIMITS.galleryTitle} ký tự
- description tối đa ${exports.BRAND_PROFILE_LIMITS.galleryDescription} ký tự
